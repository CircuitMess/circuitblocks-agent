...
cp ../pkg-assets/postinstall-cert ./scripts/postinstall
...
pkgbuild --root ./payload --ownership preserve --identifier com.circuitmess.pkg.CircuitBlocksAgent --component-plist pkg-installer.plist --scripts scripts --sign "010471773D206582CE44C296760B8E01FA57C8EC" ./circuitblocks-agent-cert.pkg
productsign --sign "87B75286D0D0D8C205B28BC29ADEFAB0AE9DD903" ./circuitblocks-agent-cert.pkg ./circuitblocks-agent-cert-signed.pkg
xcrun notarytool submit ./circuitblocks-agent-cert-signed.pkg --keychain-profile circuitblocks --wait
